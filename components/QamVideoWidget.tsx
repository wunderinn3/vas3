...
const LOOM_EMBED_URL = "https://www.loom.com/embed/bae165f6722445609c09f0755bd4a645?autoplay=1&hide_owner=true&hide_share=true&hide_title=true&hideEmbedTopBar=true";
const ROTATING_TEXT = "О ПРОДУКТЕ ЗА 94 сек •";

export default function QamVideoWidget() {
  const [visible, setVisible] = useState(false);
  const [open, setOpen] = useState(false);

  useEffect(() => {
    const section = document.getElementById('quick-ai-motion');
    if (!section) return;
    ...
    <>
      ...
      >
        <button
          ...
          aria-label="Смотреть видео о QAM"
        >
          {/* Rotating text ring */}
          <svg
          ...
          >
            ...
            <text
              ...
              fontWeight="500"
            >
              <textPath href="#circle-path" startOffset="0%">{ROTATING_TEXT}</textPath>
            </text>
            <text
              className="fill-amber-400"
              opacity="0.7"
              ...
              fontWeight="500"
            >
              <textPath href="#circle-path" startOffset="50%">{ROTATING_TEXT}</textPath>
            </text>
          </svg>
          ...
          >
            ...
            <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
              <iframe
                ...
                title="Quick AI Motion overview"
              />
            </div>
          </div>
        </div>
